        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TemporaryPasswordExpiresAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset(0)", precision: 0, nullable: true),
            ...
            migrationBuilder.CreateTable(
                name: "PasswordHelpRequests",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RequestedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset(0)", precision: 0, nullable: false),
                    ResolvedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset(0)", precision: 0, nullable: true),
                    ResolvedByUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PasswordHelpRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PasswordHelpRequests_Users_ResolvedByUserId",
                        column: x => x.ResolvedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PasswordHelpRequests_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SecurityAuditEvents_Users_SubjectUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParentProfiles_ParentCode",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParentStudentLinks_StudentProfileId_IsActive",
                table: "ParentStudentLinks",
                columns: new[] { "StudentProfileId", "IsActive" });

            migrationBuilder.CreateIndex(
                name: "IX_PasswordHelpRequests_ResolvedByUserId",
                table: "PasswordHelpRequests",
                column: "ResolvedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PasswordHelpRequests_UserId",
                table: "PasswordHelpRequests",
                column: "UserId",
                unique: true,
                filter: "[Status] = 0");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityAuditEvents_SubjectUserId_OccurredAtUtc",
                table: "SecurityAuditEvents",
